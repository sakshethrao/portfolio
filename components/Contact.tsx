  ...
  return (
    <section id="contact" className="wrap" style={{ padding: "clamp(72px, 12vw, 130px) var(--pad)" }}>
      <Reveal>
        ...
        <p style={{ fontSize: "clamp(16px, 2vw, 19px)", lineHeight: 1.6, color: "var(--muted)", margin: "20px 0 0", maxWidth: 520 }}>
          Pilots for QuantumSight, a project you want a hand with, or just to compare notes on shipping things — the inbox is open.
        </p>
