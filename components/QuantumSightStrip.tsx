      ...
      <div className="wrap" style={{ padding: "clamp(64px, 10vw, 110px) var(--pad)" }}>
        <div className="qs-strip-grid">
          <Reveal>
            ...
            <p className="sora" style={{ fontWeight: 500, fontSize: "clamp(17px, 2.4vw, 24px)", lineHeight: 1.35, color: "var(--muted)", margin: "16px 0 0", maxWidth: 440 }}>
              Making the cameras a building already has understand what they see.
            </p>

            <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 26 }}>
              <Link href="/quantumsight" className="mono pill-solid">Go inside →</Link>
